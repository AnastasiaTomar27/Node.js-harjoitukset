...
app.get('/', (req, res) => {
    ...
    res.render('index', { otsikko: 'Kotisivu', blogit });
});

app.get('/meista', (req, res) => {
    //res.sendFile('./views/meista.html', { root: __dirname });
...
app.get('/blogit/luo', (req, res) => {
    res.render('luo', { otsikko: 'Luo uusi blogi'});
});
